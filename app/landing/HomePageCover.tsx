...
import { IconPlay } from '@/components/ui/Icon/icons/IconPlay'
...
const HomePageCover = (props) => {
  ...
  const frameworks = [
    {
      tooltip: 'ReactJS',
      icon: '/img/icons/react-icon',
      href: '/guides/getting-started/quickstarts/reactjs',
    },
    {
      tooltip: 'NextJS',
      icon: '/img/icons/nextjs-icon',
      href: '/guides/getting-started/quickstarts/nextjs',
    },
    {
      tooltip: 'RedwoodJS',
      icon: '/img/icons/redwoodjs-icon',
      href: '/guides/getting-started/quickstarts/redwoodjs',
    },
    {
      tooltip: 'Flutter',
      icon: '/img/icons/flutter-icon',
      href: '/guides/getting-started/quickstarts/flutter',
    },
    {
      tooltip: 'SvelteKit',
      icon: '/img/icons/svelte-icon',
      href: '/guides/getting-started/quickstarts/sveltekit',
    },
    {
      tooltip: 'SolidJS',
      icon: '/img/icons/solidjs-icon',
      href: '/guides/getting-started/quickstarts/solidjs',
    },
    {
      tooltip: 'Vue',
      icon: '/img/icons/vuejs-icon',
      href: '/guides/getting-started/quickstarts/vue',
    },
    {
      tooltip: 'NuxtJS',
      icon: '/img/icons/nuxt-icon',
      href: '/guides/getting-started/quickstarts/nuxtjs',
    },
    {
      tooltip: 'refine',
      icon: '/img/icons/refine-icon',
    ...
    >
      <div className="col-span-full flex flex-col md:flex-row xl:flex-col justify-between gap-1 md:gap-3">
        <div className="md:max-w-xs xl:max-w-none">
          <div className="notFill flex items-center gap-3 mb-3">
            <IconBackground>
              <IconPlay className=" notFill text-brand-1100 dark:text-brand-900 w-4" />
            </IconBackground>
        ...
        <div className="flex flex-wrap md:grid md:grid-cols-4 2xl:grid-cols-5 gap-6 sm:gap-3">
          {frameworks.map((framework, i) => (
            <Link legacyBehavior key={i} href={framework.href} passHref>
