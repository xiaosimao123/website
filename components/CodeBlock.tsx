...
//   forwardedRef,
//   ...props
// }: React.forwardRef<HTMLDivElement, RootProps>) {
//   return (
//     <Box
//       ref={forwardedRef}
//       className={classNames(styles.CodeBlockRoot, className)}
...
// const CodeBlockContent = React.forwardRef<HTMLDivElement, ContentProps>(
//   function Content({ className, ...props }, forwardedRef) {
//     return (
//       <Box
//         ref={forwardedRef}
//         data-code-block-content
...
// const CodeBlockPre = React.forwardRef<HTMLPreElement, PreProps>(function pre(
//   { className, children, overflow = 'scroll', ...props },
//   forwardedRef
// ) {
//   const pre = (
...
//   forwardedRef,
//   ...props
// }: React.forwardRef<HTMLElement, CodeProps>) {
//   let root = refractor.highlight(children, language)
...
// export { CodeBlockRoot, CodeBlockCode, CodeBlockPre, CodeBlockContent }
...
export {
  Root as Root,
  LivePreview as LivePreview,
  Header as Header,
  Content as Content,
  CopyButton as CopyButton,
  Pre as Pre,
  Code as Code,
}
// export type {
