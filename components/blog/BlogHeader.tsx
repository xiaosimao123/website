...
export const BlogHeader: FC<{ post: Blog }> = ({ post }) => {
  ...
  return (
    <>
      <div className="mx-auto    mb-4 space-y-8 lg:max-w-[994px] lg:space-y-12 lg:px-16">
      ...
      <div
        className={`fixed top-16 z-10 hidden h-24 w-full border-b border-gray-200 bg-white bg-opacity-90 backdrop-blur backdrop-filter transition-opacity duration-200 dark:border-gray-800 dark:bg-gray-950 lg:block ${
          top ? 'opacity-0' : 'opacity-100'
        }`}
      >
  <div className="flex h-full items-center space-x-2 py-4 px-16 text-sm">
