...
A post on the new features introduced  `App.tsx` in v1.0. New features:
...
<FileTree>
  <FileTreeFolder name="pages" defaultOpen>
    <FileTreeFile name="_meta.json" />
    <FileTreeFile name="contact.md" />
    <FileTreeFile name="index.mdx" />
    <FileTreeFolder name="about">
      <FileTreeFile name="_meta.json" />
      <FileTreeFile name="legal.md" />
      <FileTreeFile name="index.mdx" />
    </FileTreeFolder>
  </FileTreeFolder>
</FileTree>
...
````
```js:test.js {1, 3-4} showLineNumbers
var num1, num2, sum
